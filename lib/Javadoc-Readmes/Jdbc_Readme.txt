Oracle JDBC Driver release 23.3.0.23.09 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 23.3.0.23.09 release:

  - JDBC Thin Driver 23.3.0.23.09
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 23.3.0.23.09
    Client-side JDBC driver for use on a machine where OCI 23.3.0.23.09
    is installed.

  - JDBC Thin Server-side Driver 23.3.0.23.09
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 23.3.0.23.09
...
In order to use the JDBC Thin Driver 23.3.0.23.09, please add ojdbc8.jar or
